...
days_in_house1 = int(input(f'How many days did you stayed in the house {name1} during the bill period?'))

name2 = input('What is the name of the other flatmate?')
days_in_house2 = int(input(f'How many days did you stayed in the house {name2} during the bill period?'))
